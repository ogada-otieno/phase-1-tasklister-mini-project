// the mockup provided is adding a list
// anytime you click the submit -->Create new task<--- button
// the lists created are also deletable when you click the X button
// How do you conceptualize and execute this? 
